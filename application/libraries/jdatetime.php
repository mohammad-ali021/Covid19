...
$keys = array('d','D','j','l','N','S','w','z','W','F','m','M','n','t','L','o','Y','y','a','A','P','c','r','e','T');
...
break;
case 'P':
$v = ($obj->format('P') == 'PM') ? 'قبل از ظهر' : 'بعد از ظهر';
break;
//Full Dates
case 'c':
...
$ret = '';
switch ( $month ) {
case '۰۱': $ret = 'حمل'; break;
case '۰۲': $ret = 'ثور'; break;
case '۰۳': $ret = 'جوزا'; break;
case '۰۴': $ret = 'سرطان'; break;
case '۰۵': $ret = 'اسد'; break;
case '۰۶': $ret = 'سنبله'; break;
case '۰۷': $ret = 'میزان'; break;
case '۰۸': $ret = 'عقرب'; break;
case '۰۹': $ret = 'قوس'; break;
case '۱۰': $ret = 'جدی'; break;
case '۱۱': $ret = 'دلو'; break;
case '۱۲': $ret = 'حوت'; break;
}
